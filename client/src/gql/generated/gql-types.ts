...
export type BaseBook = {
  ...
  covers?: Maybe<Array<Array<Scalars["String"]>>>;
...
export type ViewTask_Task_Parts_Fragment = { __typename?: "Task" } & Pick<
  Task,
...
export type ViewTask_TaskHistory_All_Fragment = {
  ...
  TaskHistory,
  "_id" | "taskId" | "taskStatus" | "autoGenerated" | "title" | "description"
>;
...
export type UpdateTaskMutation = { __typename?: "Mutation" } & {
  updateTask: { __typename?: "Task" } & ViewTask_Task_Parts_Fragment;
};
...
export type GetTaskQuery = { __typename?: "Query" } & {
  getTask: { __typename?: "Task" } & {
    history: { __typename?: "TaskHistoryResponse" } & {
      page: { __typename?: "TaskHistoryConnection" } & {
        edges?: Maybe<
          Array<
            { __typename?: "TaskHistoryEdge" } & Pick<
              TaskHistoryEdge,
              "cursor"
            > & {
                node?: Maybe<
        ...
        >;
        pageInfo?: Maybe<
          { __typename?: "TaskHistoryPageInfo" } & Pick<
            TaskHistoryPageInfo,
...
export type GetTasksQuery = { __typename?: "Query" } & {
  getTasks: { __typename?: "UserTasksResponse" } & {
    page: { __typename?: "UserTaskConnection" } & {
      edges?: Maybe<
        Array<
          { __typename?: "UserTaskEdge" } & Pick<UserTaskEdge, "cursor"> & {
              node?: Maybe<
                { __typename?: "UserTask" } & ViewTasks_UserTask_All_Fragment
              >;
            }
        >
      >;
      pageInfo?: Maybe<
        { __typename?: "UserTaskPageInfo" } & Pick<
          UserTaskPageInfo,
          "endCursor" | "hasNextPage" | "hasPreviousPage" | "startCursor"
        >
      >;
    ...
    pageData?: Maybe<
      { __typename?: "PageData" } & Pick<PageData, "count" | "limit" | "offset">
    >;
  };
};
...
export function getSdk(
  ...
  return {
    ...
    updateTask(
      ...
      return withWrapper(() =>
        client.request<UpdateTaskMutation>(
          UpdateTaskDocument,
          variables,
          requestHeaders
        )
    ...
    getTask(
      ...
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetTaskQuery> {
      return withWrapper(() =>
        client.request<GetTaskQuery>(GetTaskDocument, variables, requestHeaders)
      );
    },
    getTaskHistory(
      variables: GetTaskHistoryQueryVariables,
      requestHeaders?: Dom.RequestInit["headers"]
    ): Promise<GetTaskHistoryQuery> {
      return withWrapper(() =>
        client.request<GetTaskHistoryQuery>(
